...
myArgs.forEach(element => {
  ...
  fs.writeFile(`./helpers/${element}.helper.js`, a, err => {
    if (err) throw err
  ...
  // Middleware
  fs.writeFile(`./middlewares/${element}.middleware.js`, getMiddlewareContent(element), err => {
    if (err) throw err
  ...
  // Route
  fs.writeFile(`./routes/${element}.route.js`, getRouteContent(element), err => {
    if (err) throw err
  ...
  // Controller
  fs.writeFile(`./controllers/${element}.controller.js`, getControllerContent(element), err => {
    if (err) throw err
